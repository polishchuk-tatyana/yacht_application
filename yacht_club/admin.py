...
class Yacht_Elements(admin.ModelAdmin):
    ...
    # fields = ["name"]
    search_fields = ['type', 'model', 'cabin', 'max_human', 'year', 'length', 'motor', 'users__surname', 'club__name',
                     'manufacturer__name', 'paid']
...
class Lease_Elements(admin.ModelAdmin):
    ...
    # fields = ["name"]
    search_fields = ['yacht_model', 'users_surname', 'pay_method', 'rent_start', 'rent_finish', 'capitan', 'paid',
                     'certification']
